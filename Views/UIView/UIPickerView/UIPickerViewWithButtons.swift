...
class UIPickerViewWithButtons: UIPickerView {
    ...
    func setup() {
        ...
        doneButton = UIBarButtonItem(title: doneButtonTitle, style: UIBarButtonItemStyle.Plain, target: self, action: "donePicker")
        let spaceButton = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.FlexibleSpace, target: nil, action: nil)
        cancelButton = UIBarButtonItem(title: cancelButtonTitle, style: UIBarButtonItemStyle.Plain, target: self, action: "cancelPicker")
